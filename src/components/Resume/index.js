    ...
    <div className="resume">
      ...
      <div className="resume--main">
        ...
        <p>
          ...
          Compositional work focused on generative electronic music systems, and
        ...
        <p>
          ...
          with web frameworks, including React and Flask, HTML, CSS, Bootstrap,
          as well as REST APIs, database management and backend technologies.
        </p>
        ...
        <h3>Education</h3>
        <h4>
          Ithaca College, Ithaca, NY -- Music Composition, magna cum laude, 2021
        </h4>
        ...
        <p>
          Student organizer for Student-Led New Music conference taking place in
          April 2021
        </p>
        <h4>
